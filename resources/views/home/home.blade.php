...
@php
    ...
    if($computer_hiyokotyping_record >= 80){$computer_hiyokotyping_reward = 'diamond'; $computer_hiyokotyping_level = 'ダイヤモンド';$diamond++;}
    elseif($computer_hiyokotyping_record >= 60){$computer_hiyokotyping_reward = 'gold'; $computer_hiyokotyping_level = '金';$gold++;}
    elseif($computer_hiyokotyping_record >= 40){$computer_hiyokotyping_reward = 'silver'; $computer_hiyokotyping_level = '銀';$silver++;}
